...
from twj_utils import get_mean_stdev_from_stableaudio2_latents
...
class Llasa(nn.Module):
    ...
    def forward(
        ...
        # print('audio_distribution_l', audio_distribution_l.shape) # audio_distribution_l torch.Size([2, 261, 128])
